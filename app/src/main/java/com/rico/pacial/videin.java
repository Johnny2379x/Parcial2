...
public class videin extends AppCompatActivity {
    WebView webView;
    VideoView videoView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_videin);
        videoView = (VideoView) findViewById(R.id.videoMigato);
        String videoPath= "android.resource://"+getPackageName()+"/"+R.raw.gatitos;
        //videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.gatitos));
